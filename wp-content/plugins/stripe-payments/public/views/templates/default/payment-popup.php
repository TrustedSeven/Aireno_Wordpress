...
<div id="Aligner" class="Aligner">
    <?php if (!$a['data']['is_live']) { ?>
        <a href="https://stripe.com/docs/testing#cards" target="_blank"
           id="test-mode"><?php esc_html_e('TEST MODE', 'stripe-payments'); ?></a>
    <?php } ?>
        ...
        <div id="modal-body" class="pure-g">
            <div class="pure-u-1">
                ...
                <form method="post" id="payment-form"
                      class="pure-form pure-form-stacked" <?php echo isset($a['fatal_error']) ? 'style="display: none;"' : ''; ?>>
                    ...
                    <?php if ($a['data']['amount_variable'] && !$this->item->get_meta('asp_product_hide_amount_input')) { ?>
                        <div id="amount-cont" class="pure-u-1">
                            ...
                            <input class="pure-input-1" id="amount" name="amount" inputmode="decimal"
                                   value="<?php echo esc_attr(!empty($a['data']['item_price']) ? ASP_Utils::formatted_price($a['data']['item_price'], false, true) : ''); ?>"
                                   required>
                    ...
                    <?php if ($a['data']['custom_quantity']) { ?>
                        <div id="quantity-cont" class="pure-u-1">
                            ...
                            <input type="number" min="1" class="pure-input-1" id="quantity" name="quantity"
                                   inputmode="numeric" value="<?php echo esc_attr($a['data']['quantity']); ?>" required>
                        ...
                        <div id="coupon-cont" class='pure-u-1'>
                            ...
                            <div id="coupon-input-cont">
                                <div style="position: relative;">
                                    ...
                                    <button id="apply-coupon-btn" class="pure-button"
                                            type="button"><?php echo esc_html(__('Apply', 'stripe-payments')); ?></button>
                                </div>
                                <div id="coupon-err" class="form-err" role="alert"></div>
                            </div>
                            <div id="coupon-res-cont" style="display: none;">
                                <span id="coupon-info"></span>
                                <button id="remove-coupon-btn" class="pure-button"
                                        type="button"><?php echo esc_html(__('Remove', 'stripe-payments')); ?></button>
                            </div>
                        </div>
                    <?php } ?>
                            ...
                            <fieldset>
                                ...
                                <table class="pure-table pure-table-horizontal" style="width: 100%;">
                                    ...
                                    <tr id="order-item-line">
                                        ...
                                        <td>
                                            <span id="order-item-price"><?php echo esc_html(AcceptStripePayments::formatted_price($this->item->get_price(), $this->item->get_currency())); ?></span>
                                        </td>
                                    </tr>
                                    <?php
                                    ...
                                    if (!empty($items)) {
                                        foreach ($items as $item) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span id="order-item-price"><?php echo esc_html(AcceptStripePayments::formatted_price($item['price'], $this->item->get_currency())); ?></span>
                                                </td>
                                            </tr>
                                            <?php
                                        }
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span id="order-total"><?php echo esc_html(AcceptStripePayments::formatted_price($this->item->get_total(), $this->item->get_currency())); ?></span>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="pure-g">
                            <fieldset id="name-email-cont" style="width: 100%;">
                                <div class="pure-u-1 pure-u-md-11-24">
                                    ...
                                    <div style="position: relative;">
                                        <svg id="i-user" class="icon input-icon" xmlns="http://www.w3.org/2000/svg"
                                             viewBox="0 0 32 32" width="32" height="32" fill="none"
                                             stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round"
                                             stroke-width="2">
                                            <path d="M22 11 C22 16 19 20 16 20 13 20 10 16 10 11 10 6 12 3 16 3 20 3 22 6 22 11 Z M4 30 L28 30 C28 21 22 20 16 20 10 20 4 21 4 30 Z"/>
                                        </svg>
                                        <input class="pure-input-1 has-icon" type="text" id="billing-name"
                                               name="billing_name"
                                               value="<?php echo esc_attr($a['data']['customer_name']); ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="pure-u-1 pure-u-md-12-24">
                                    ...
                                    <div style="position: relative;">
                                        <svg id="i-mail" class="icon input-icon" xmlns="http://www.w3.org/2000/svg"
                                             viewBox="0 0 32 32" width="32" height="32" fill="none"
                                             stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round"
                                             stroke-width="2">
                                            <path d="M2 26 L30 26 30 6 2 6 Z M2 6 L16 16 30 6"/>
                                        </svg>
                                        <input class="pure-input-1 has-icon" type="email" id="email" name="email"
                                               value="<?php echo esc_attr($a['data']['customer_email']); ?>" required>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
                                ...
                                <div class="half-inner-left">
                                    <fieldset>
                                        ...
                                        <div class="pure-u-1 pure-u-md-14-24 baddr-toggle" style="position: relative;">
                                            ...
                                            <div style="position: relative;">
                                                <svg id="i-location" class="icon input-icon"
                                            ...
                                            <input class="pure-input-1 has-icon" type="text" id="address" name="address"
                                                   required>
                                        </div>
                                        ...
                                        <div class="pure-u-1 pure-u-md-<?php echo $a['hide_state_field'] ? '14' : '10'; ?>-24 baddr-toggle"
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="pure-u-1" style="position: relative;">
                                            ...
                                            <div style="position: relative;">
                                                ...
                                                <input class="pure-input-1 has-icon saddr-required" type="text"
                                                       id="shipping_address" name="shipping_address">
                                            </div>
                                        </div>
                                        <div class="pure-u-1" style="position: relative;">
                                            <label for="shipping_city"><?php esc_html_e('City', 'stripe-payments'); ?></label>
                                            <input class="pure-input-1 saddr-required" type="text" id="shipping_city"
                                                   name="shipping_city">
                                        </div>
                                        <div class="pure-u-1" style="position: relative;">
                                            <label for="shipping_country"><?php esc_html_e('Country', 'stripe-payments'); ?></label>
                                            <select class="pure-input-1 saddr-required" name="shipping_country"
                                                    id="shipping_country">
                                                <?php echo wp_kses(ASP_Utils::get_countries_opts($a['data']['customer_default_country']), ASP_Utils::asp_allowed_tags()); ?>
                                            </select>
                                        </div>
                                        <?php if (!$a['hide_state_field']) { ?>
                                            <div class="pure-u-1">
                                                ...
                                                <input class="pure-u-1" type="text" name="shipping_state"
                                                       id="shipping_state">
                                            </div>
                                        <?php } ?>
                                        <div class="pure-u-1">
                                            ...
                                            <input class="pure-u-1" type="text" name="shipping_postcode"
                ...
                <?php } ?>
                    ...
                    <div id="buttons-container">
                        <div class="pure-u-5-5" style="position: relative;">
                            <div id="submit-btn-cont" data-pm-name="def" class="pure-u-5-5 centered">
                                <button type="submit" id="submit-btn" class="pure-button pure-button-primary"
                                        disabled><?php echo esc_html($a['pay_btn_text']); ?></button>
                            </div>
                            <?php
                    ...
                    <input type="hidden" id="btn-uniq-id" name="btn_uniq_id"
                           value="<?php echo !empty($a['btn_uniq_id']) ? esc_attr($a['btn_uniq_id']) : ''; ?>">
                    <input type="hidden" id="product-id" name="product_id"
                           value="<?php echo esc_attr($a['prod_id']); ?>">
                    ...
                    <?php } ?>
                    <input type="hidden"
                           value="<?php echo !empty($a['thankyou_page']) ? esc_attr(base64_encode($a['thankyou_page'])) : ''; ?>"
                           name="thankyou_page_url" id="thankyou_page_url">
