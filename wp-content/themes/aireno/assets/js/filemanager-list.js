...
var KTFileManagerList = function () {
    ...
    const l = () => {
        ...
        const a = o.target.closest("tr"), l = a.querySelectorAll("td")[1], i = l.querySelector(".svg-icon");
        r = l.innerText;
        ...
        document.querySelector("#kt_file_manager_rename_folder").addEventListener("click", (t => {
            t.preventDefault(), c && c.validate().then((function (t) {
                console.log("validated!"), "Valid" == t && Swal.fire({
        ...
        t.querySelectorAll('[data-kt-filemanger-table="copy_link"]').forEach((e => {
            const t = e.querySelector("button"),
                ...
                n = e.querySelector('[data-kt-filemanger-table="copy_link_result"]'), r = e.querySelector("input");
    ...
    return {
        init: function () {
            (t = document.querySelector("#kt_file_manager_list")) && (o = document.querySelector('[data-kt-filemanager-template="upload"]'), n = document.querySelector('[data-kt-filemanager-template="rename"]'), r = document.querySelector('[data-kt-filemanager-template="action"]'), a = document.querySelector('[data-kt-filemanager-template="checkbox"]'), (() => {
                ...
                const e = "#kt_modal_upload_dropzone", t = document.querySelector(e);
                ...
                r.on("addedfile", (function (o) {
                    ...
                    r.files.forEach((e => {
                        ...
                        t.style.opacity = "1";
                        var o = 1, n = setInterval((function () {
