...
?>
<body id="kt_body" <?php body_class('header-fixed header-tablet-and-mobile-fixed'); ?>
                        ...
                        <div class="d-lg-block p-5 p-lg-0" data-kt-drawer="true" data-kt-drawer-name="landing-menu"
                            ...
                            <?php wp_nav_menu(
                                array(
                                    ...
                                    'container_class' => 'menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-800 menu-state-title-primary nav nav-flush fw-bolder',
