                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="mb-18">
                            ...
                            <div class="mb-10">
                                ...
                                <div class="overlay">
                                    <!--begin::Image-->
                                    <img class="w-100 card-rounded" src="<?=get_theme_file_uri("assets/images/img-1.jpg")?>" alt="" />
                                    <!--end::Image-->
                                    <!--begin::Links-->
                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        <a href="../../demo1/dist/pages/pricing/pricing-2.html" class="btn btn-primary">Pricing</a>
                            ...
                            <div class="row g-10">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card-xl-stretch me-md-6">
                                        <!--begin::Overlay-->
                                        <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales" href="<?=get_theme_file_uri("assets/images/img-73.jpg")?>">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px" style="background-image:url('<?=get_theme_file_uri("assets/images/img-73.jpg")?>')"></div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                        ...
                                        <div class="m-0">
                                            ...
                                            <div class="fs-6 fw-bolder">
                                                <!--begin::Author-->
                                                <a href="../../demo1/dist/apps/projects/users.html" class="text-gray-700 text-hover-primary">Jane Miller</a>
                                                <!--end::Author-->
                                                <!--begin::Date-->
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card-xl-stretch mx-md-3">
                                        <!--begin::Overlay-->
                                        <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales" href="<?=get_theme_file_uri("assets/images/img-74.jpg")?>">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px" style="background-image:url('<?=get_theme_file_uri("assets/images/img-74.jpg")?>')"></div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer bg-dark card-rounded bg-opacity-25">
                                                <i class="bi bi-eye-fill fs-2x text-white"></i>
                                        ...
                                        <div class="m-0">
                                            ...
                                            <div class="fs-6 fw-bolder">
                                                <!--begin::Author-->
                                                <a href="../../demo1/dist/apps/projects/users.html" class="text-gray-700 text-hover-primary">Cris Morgan</a>
                                                <!--end::Author-->
                                                <!--begin::Date-->
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card-xl-stretch ms-md-6">
                                        <!--begin::Overlay-->
                                        <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales" href="<?=get_theme_file_uri("assets/images/img-47.jpg")?>">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px" style="background-image:url('<?=get_theme_file_uri("assets/images/img-47.jpg")?>')"></div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer bg-dark card-rounded bg-opacity-25">
                                                <i class="bi bi-eye-fill fs-2x text-white"></i>
                                        ...
                                        <div class="m-0">
                                            ...
                                            <div class="fs-6 fw-bolder">
                                                <!--begin::Author-->
                                                <a href="../../demo1/dist/apps/projects/users.html" class="text-gray-700 text-hover-primary">Carles Nilson</a>
                                                <!--end::Author-->
                                                <!--begin::Date-->
                        ...
                        <div class="mb-18">
                            ...
                            <div class="tns tns-default mb-10">
                                ...
                                <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000" data-tns-autoplay="true" data-tns-autoplay-timeout="18000" data-tns-controls="true" data-tns-nav="false" data-tns-items="1" data-tns-center="false" data-tns-dots="false" data-tns-prev-button="#kt_team_slider_prev" data-tns-next-button="#kt_team_slider_next" data-tns-responsive="{1200: {items: 3}, 992: {items: 2}}">
                                    ...
                                    <div class="text-center">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('<?="https://secure.gravatar.com/avatar/1b303d22706b7f28a9a0b946d620541d?s=60&d=mm&r=g"?>')"></div>
                                        <!--end::Photo-->
                                        <!--begin::Person-->
                                        <div class="mb-0">
                                            <!--begin::Name-->
                                    ...
                                    <div class="text-center">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('<?=get_theme_file_uri("assets/images/300-2.jpg")?>')"></div>
                                        <!--end::Photo-->
                                        <!--begin::Person-->
                                        <div class="mb-0">
                                            <!--begin::Name-->
                                    ...
                                    <div class="text-center">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('<?=get_theme_file_uri("assets/images/300-5.jpg")?>')"></div>
                                        <!--end::Photo-->
                                        <!--begin::Person-->
                                        <div class="mb-0">
                                            <!--begin::Name-->
                                    ...
                                    <div class="text-center">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('<?=get_theme_file_uri("assets/images/300-20.jpg")?>')"></div>
                                        <!--end::Photo-->
                                        <!--begin::Person-->
                                        <div class="mb-0">
                                            <!--begin::Name-->
                                    ...
                                    <div class="text-center">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('<?=get_theme_file_uri("assets/images/300-23.jpg")?>')"></div>
                                        <!--end::Photo-->
                                        <!--begin::Person-->
                                        <div class="mb-0">
                                            <!--begin::Name-->
                                    ...
                                    <div class="text-center">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('<?=get_theme_file_uri("assets/images/300-12.jpg")?>')"></div>
                                        <!--end::Photo-->
                                        <!--begin::Person-->
                                        <div class="mb-0">
                                            <!--begin::Name-->
                                    ...
                                    <div class="text-center">
                                        <!--begin::Photo-->
                                        <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('<?=get_theme_file_uri("assets/images/300-9.jpg")?>')"></div>
                                        <!--end::Photo-->
                                        <!--begin::Person-->
                                        <div class="mb-0">
                                            <!--begin::Name-->
                        ...
                        <div class="card mb-4 bg-light text-center">
                            ...
                            <div class="card-body py-12">
                                <!--begin::Icon-->
                                <a href="#" class="mx-4">
                                    <img src="<?=get_theme_file_uri("assets/images/facebook-4.svg")?>" class="h-30px my-2" alt="" />
                                </a>
                                <!--end::Icon-->
                                <!--begin::Icon-->
                                <a href="#" class="mx-4">
                                    <img src="<?=get_theme_file_uri("assets/images/instagram-2-1.svg")?>" class="h-30px my-2" alt="" />
                                </a>
                                <!--end::Icon-->
                                <!--begin::Icon-->
                                <a href="#" class="mx-4">
                                    <img src="<?=get_theme_file_uri("assets/images/github.svg")?>" class="h-30px my-2" alt="" />
                                </a>
                                <!--end::Icon-->
                                <!--begin::Icon-->
                                <a href="#" class="mx-4">
                                    <img src="<?=get_theme_file_uri("assets/images/behance.svg")?>" class="h-30px my-2" alt="" />
                                </a>
                                <!--end::Icon-->
                                <!--begin::Icon-->
                                <a href="#" class="mx-4">
                                    <img src="<?=get_theme_file_uri("assets/images/pinterest-p.svg")?>" class="h-30px my-2" alt="" />
                                </a>
                                <!--end::Icon-->
                                <!--begin::Icon-->
                                <a href="#" class="mx-4">
                                    <img src="<?=get_theme_file_uri("assets/images/twitter.svg")?>" class="h-30px my-2" alt="" />
                                </a>
                                <!--end::Icon-->
                                <!--begin::Icon-->
                                <a href="#" class="mx-4">
                                    <img src="<?=get_theme_file_uri("assets/images/dribbble-icon-1.svg")?>" class="h-30px my-2" alt="" />
                                </a>
                                <!--end::Icon-->
                            </div>
                            <!--end::Body-->
