            ...
            <script src="<?=get_theme_file_uri("assets/js/typedjs.bundle.js")?>"></script>
              ...
              <div class="row justify-content-center">  
               <div class="text-center col-12 col-md-8">
                 <h1 class="display-1">Aireno
											<span class="d-inline-block position-relative">
											<span class="display-1">Business</span>
											<span class="d-inline-block position-absolute h-8px bottom-0 end-0 start-0 bg-danger translate rounded"></span>
											</span>
                      </h1>
                  <div class="fw-semibold fs-2 text-muted m-10"><span class="fw-bold text-danger">Ready to transform your <span id="typed" class="fw-bolder"></span>business?</span><br/>
                  <span data-bs-toggle="tooltip" title="Build a precise quote instantly. Our quote engine uses a smart questionaire & real market pricing data to generate a quote on the spot. " class="fw-bolder text-dark" >Magically quote</span>, qualify, contract & manage your projects on autopilot with <span class="fw-bolder text-dark">Aireno.</span> 
								</div>
                 <script>
             var typed = new Typed("#typed", {
            strings: ["Bathroom renovation", "Kitchen renovation", "House extension", "Home renovation", "Painting", "Flooring", "Electrical", "Plumbing"],
            typeSpeed: 60,
            loop: true  
             });
            </script>
          ...
          <div class="d-flex flex-column p-5">
            ...
            <ul class="nav nav-pills nav-pills-custom justify-content-center mb-3" role="tablist">
              ...
              <li class="nav-item mb-3 me-3 me-lg-6" role="presentation">
                <!--begin::Link-->
                <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-danger flex-column overflow-hidden w-150px h-100px pt-5 pb-2 active" id="kitchen_link" data-bs-toggle="tab" href="#kitchen_tab" role="tab" aria-selected="true">
                  <!--begin::Icon-->
            ...
            <div class="tab-content">
               <div class="tab-pane fade show active" id="kitchen_tab" role="tabpanel" aria-labelledby="#kitchen_link">
                <!--begin::Row-->
                <!--begin::Row-->
                      ...
                      <li class="nav-item" role="presentation">
                        <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6" id="fulltab4" data-bs-toggle="tab" data-bs-target="#full4" type="button" role="tab" aria-controls="full4" aria-selected="false">
                          ...
                          <div class="d-flex align-items-center me-2">
                            <!--begin::Info-->
                            <div class="flex-grow-1">
                              <div class="fw-semibold opacity-75 badge badge-circle badge-light-danger text-danger fw-bolder p-5 me-3 fs-3">
                                <i class="fa-solid fa-check fw-bolder text-danger"></i>
                              </div>
                              <div class="d-flex align-items-center fs-2 fw-bolder flex-wrap">
