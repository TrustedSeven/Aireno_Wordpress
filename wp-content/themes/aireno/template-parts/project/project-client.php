            ...
            <div class="content d-flex flex-column flex-column-fluid"
                ...
                <div class="post d-flex flex-column-fluid" id="kt_post">
                    ...
                    <div id="kt_content_container" class="container">
                      <div class="alert alert-primary bg-light-primary border border-primary d-flex align-items-center p-5 mb-10">
                      <!--begin::Svg Icon | path: icons/duotune/general/gen048.svg-->
                        <span class="me-4"><i class="fa-sharp fa-solid fa-handshake-angle text-primary fs-2x"></i>
                        </span>
                        <!--end::Svg Icon-->                   
                        <div class="d-flex flex-column">
                        <h4 class="mb-1 text-primary">Get help with your project</h4>
                        <span>Get instantly connected to project planners, designers and estimators ready to asist you regardless of what stage you are in. <a class="btn btn-primary btn-sm fw-bolder" href="" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">View Options</a></span>
                        </div>
                        </div>
                        <!--begin::Navbar-->
                            ...
                            <div class="card-body pt-9 pb-0">
                                            ...
                                            <div class="d-flex mb-4">
                                                 <span class="me-3">
                                                    <a href="javascript:void(0)"
                                                       ...
                                                       data-bs-toggle="modal"
                                                       data-bs-target="#kt_modal_upgrade_plan">Get Extra Help <i class="fa-shar fa-solid fa-handshake-angle fw-bolder"></i>
                                                    </a>
                                                </span>
                                                <?php
                                                if ($projectStatus->status == 'pending') {
                                                    $asp_product = aireno_get_asp_product_for_project($project_id);

                                                    if ($asp_product){
                                                        ?>
                                                        <div class="d-none aspBtnContainer">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="'.$project_title.' Acceptance Fee" product_id="'.$asp_product.'"]');
                                                            ?>
                                                        </div>
                                                        <?php
                                                    }
                                                    ?>
                                                    <a class="btn btn-success btn-sm fw-bolder me-5" data-bs-toggle="modal"
                                                       data-bs-target="#kt_modal_accept_project">Accept</a>
                                                    <?php
                                                }
                                ...
                                <ul
                                    ...
                                    <li class="nav-item"><a
                                                ...
                                                data-bs-toggle="tab" href="#project-schedules">Progess</a></li>
                                    <!--end::Nav item-->
                                    <!--begin::Nav item-->
                                    <li class="nav-item"><a
                            ...
                            <div class="tab-pane fade show <?= $tab == 'project-contract' ? 'active' : '' ?>"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header card-header-stretch">
                                        <!--begin::Title-->
                                        <div class="card-title d-flex align-items-center">
                                            <h3 class="fw-bolder m-0 text-gray-800">Terms & Conditions</h3>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Card head-->
                        ...
                        <div class="border-dark border-1 mb-7 border-solid scroll-y pe-3"
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12">
                                    <!--begin::Content-->
                                    <div class="fw-bold">
                                        <h4 class="my-5 ps-2 text-dark-900 fw-bolder">Project Contract</h4>
                                        <div class="ps-2">
                                            <?= apply_filters('the_content', get_field('contract', $project_id)); ?>
                                        </div>
                                    </div>
