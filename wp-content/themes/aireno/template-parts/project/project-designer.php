												...
												<span
                                                    ...
                                                    <a href="javascript:void(0)"
                                                       class="btn btn-icon btn-active-color-primary text-hover-primary">
                                                            ...
                                                            class="badge badge-light-success me-auto cursor-pointer"><?= $projectStatus->label ?></span>
                                                </div>
                                                <!--end::Status-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <div
													...
													<span class="fs-4 fw-bolder me-3"> <span
                                                                class="project-date"><?= $project_date ?></span>
													</span>
                                                    </div>
                                                    <!--end::Number-->
                                                    <!--begin::Label-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
													<span class="fs-4 fw-bolder me-3"> <span
                                                                class="project-stage"><?= $project_stage ?></span>
													</span>
                                                    </div>
                                                    <!--end::Number-->
                                                    <!--begin::Label-->
