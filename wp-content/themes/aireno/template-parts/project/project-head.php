...
?>
                            ...
                            <div class="card-body pt-9 pb-0">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex flex-column">
												...
												<span
                                                        class="text-gray-800 text-hover-primary fs-2 fw-bolder me-3 project-name"><?= $project_title ?></span>
                                                    <a href="javascript:void(0)"
                                                       class="btn btn-icon btn-active-color-primary text-hover-primary"
                                                       data-bs-toggle="modal"
                                                       data-bs-target="#kt_modal_edit_project_name"> <i
                                                                class="bi bi-pencil-fill fs-4 text-dark"></i>
                                                    </a>
                                                    <span class="badge badge-light-success me-auto cursor-pointer project-status"
                                                          data-bs-toggle="modal"
                                                          data-bs-target="#kt_modal_manage_project_status"><div
                                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                                title="Current status of project. Click to change">
                                                    Status: <?= $projectStatus->label ?></div></span>
                                                </div>
                                                <!--end::Status-->
                                                <!--begin::Description-->
                                                <div class="d-flex flex-wrap">
												<span class="fw-bold mb-4 fs-5 text-gray-400 me-3"> <span
                                                            class="project-address"><?= $project_address ?></span> <a
                                            ...
                                            <div class="d-flex mb-4">
						                                    <span class="me-3">
                                                    <a href="javascript:void(0)"
                                                       class="btn btn-outline btn-outline-dashed btn-sm btn-outline-danger btn-active-light-danger fw-bolder"
                                                       data-bs-toggle="modal"
                                                       data-bs-target="#kt_modal_upgrade_plan">Get Extra Help <i
                                                                class="fa-regular fa-handshake-angle fw-bolder"></i>
                                                    </a>
                                                </span>
                                                <?php
                                                        ...
                                                        if ($projectStatus->status != 'completed' &&
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a href="javascript:void(0)"
                                                                   ...
                                                                   data-bs-toggle="modal"
                                                                   data-bs-target="#kt_modal_manage_project_fee">Manage
                                                                    Project Fee</a>
                                                            </div>
                                                            <!--end::Menu item-->
                                                            <!--begin::Menu item-->
                                                            <div class="menu-item px-3 my-1">
                                                                <a href="javascript:void(0)"
                                                                   class="menu-link px-3 btnLoadContacts">Add Users</a>
                                                            </div>
                                                            <!--end::Menu item-->
                                                            <!--begin::Menu item-->
                                                            <div class="menu-item px-3">
                                        ...
                                        <div class="d-flex flex-wrap justify-content-start">
                                            ...
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <div
                                                    ...
                                                    <!--end::Number-->
                                                    <!--begin::Label-->
                                                    <div class="fw-bold fs-6 text-gray-400">Total Quote</div>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Budget-->
                                                <!--begin::Users-->
                                                    ...
                                                    <div class="symbol-group symbol-hover mb-3">
                                                        ...
                                                        foreach ($team_members as $team_member) {
                                                            ...
                                                            <a class="symbol symbol-35px symbol-circle"
                                                               ...
                                                               title="<?= $team_member->display_name ?>">
                                                                <img class="mw-100" src="<?= $team_member->avatar ?>"
                                                                     alt="avatar"/>
                                                            </a>
                                                            <?php
                                                        }
                                ...
                                <ul
                                    ...
                                    <li class="nav-item"><a
                                                ...
                                                data-bs-toggle="tab" href="#project-schedules">Progress</a></li>
                                    <!--end::Nav item-->
                                    <!--begin::Nav item-->
                                    <li class="nav-item"><a
                                    ...
                                    <li class="nav-item"><a
                                                ...
                                                data-bs-toggle="tab" href="#project-users">Team</a></li>
                                    <!--end::Nav item-->
                                    <!--begin::Nav item-->
                                    <li class="nav-item"><a
                                                class="nav-link text-active-primary py-5 me-6 <?= $tab == 'project-files' ? 'active' : '' ?>"
                                                data-bs-toggle="tab" href="#project-files">Uploads</a></li>
                                    <!--end::Nav item-->
                                    <!--begin::Nav item-->
                                    <li class="nav-item"><a
                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="card" id="kt_quotes_summary">
                                            <div class="card-header collapsible cursor-pointer"
                                                 id="kt_quotes_summary_header" data-bs-toggle="collapse"
                                                 data-bs-target="#kt_quotes_card_collapsible">
                                                <div class="card-title">
                                                    <h3 class="fw-bolder">
                                                        <i class="fa-light fs-4 me-1 text-danger fa-scanner-keyboard"></i>
                                                        Quote Breakdown</a>
                                                    </h3>
                                                </div>
                                                <div class="card-toolbar">
                                                    <div class="btn-group btn-group-sm">
                                                        <a class="btn btn-light-danger" href="<?= $add_scope_link ?>">
                                                            <i class="fa-regular fa-circle-plus"></i> Add New
                                                        </a>
                                                        <a class="btn btn-light-dark" href="javascript:void(0)"
                                                           id="btnPrintQuotes" title="Print to PDF"><i
                                            ...
                                            <div id="kt_quotes_card_collapsible" class="collapse show">
                                                <div class="card-body" id="kt_quotes_summary_body">
                                                    <!--begin::Quotes-->
                                                    <div class="scroll-x hover-scroll d-flex">
                                                        <?php
                                                        foreach ($scopes as $scope) {
                                                            $scope_title = get_post($scope)->post_title;
                                                            $scope_total = get_field('scope_price', $scope);
                                                            $scope_photo = get_field('template_icon', $scope);
                                                            ?>
                                                            <div class="btn-group m-1">
                                                                <button class="btn btn-flex btn-light-danger px-6 dropdown-toggle"
                                                                        type="button" data-bs-toggle="dropdown"
                                                                        aria-expanded="false">
                                                                    <span class="svg-icon svg-icon-2x"><i
                                                                                class="<?php echo $scope_photo; ?> fs-2 text-dark fw-bolder p-0"></i></span>
                                                                    <span class="d-flex flex-column align-items-start ms-2">
                                                        <span class="fs-6 fw-bolder"><?php echo $scope_title; ?></span>
                                                        <span class="fs-8 fw-bold">$<?php echo $scope_total; ?></span>
                                                    </span>
                                                                </button>
                                                                <ul class="dropdown-menu mt-n20">
                                                                    <li><a class="dropdown-item" target="_blank"
                                                                           href="<?= get_permalink($scope) ?>">Edit
                                                                            Quote</a></li>
                                                                    <li><a class="dropdown-item btn_aireno_delete_quote"
                                                                           data-quote-id="<?= $scope ?>"
                                                                           href="javascript:void(0)">Delete quote</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            <?php
                                                    ...
                                                    <div
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <h4 class="d-flex align-items-center text-dark fw-bolder cursor-pointer mb-0">
                                                                            ...
                                                                            <span class="symbol symbol-20px me-1">
                                                                                <span class="symbol-label rounded-0">
                                                                                    <i class="fa-regular fa-notes fs-2 text-dark fw-bolder p-0"></i>
                                                                                </span>
                                                                            </span>
                                                                            <!--end:Icon-->
                                                                            Notes
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex align-items-center">
                                                                                    ...
                                                                                    <h4 class="d-flex align-items-center text-gray-700 fw-bolder cursor-pointer mb-0">
                                                                                        ...
                                                                                        <span class="symbol symbol-20px me-1">
                                                                                            <span class="symbol-label rounded-0">
                                                                                                <i class="<?php echo $sIcon; ?> fs-2 text-dark fw-bolder p-0"></i>
                                                                                            </span>
                                                                                        </span>
                                                                                        <!--end:Icon-->
                                                                                        <?= $name ?>
                                                        ...
                                                        foreach ($refine_data as $cat => $data) {
                                                            ...
                                                            <div class="m-0 w-100">
                                                                <!--begin::Heading-->
                                                                <div
                                                                        class="d-flex justify-content-between collapsible py-3 collapsed toggle mb-0"
                                                                        data-bs-toggle="collapse"
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <h4 class="d-flex align-items-center text-dark fw-bolder cursor-pointer mb-0">
                                                                            ...
                                                                            <span class="symbol symbol-20px me-1">
                                                                                <span class="symbol-label rounded-0">
                                                                                    <i class="<?php echo $cat_icon; ?> fs-2 text-dark fw-bolder p-0"></i>
                                                                                </span>
                                                                            </span>
                                                                            <!--end:Icon-->
                                                                            <?= get_term($cat)->name ?>
                                                                    ...
                                                                    <div class="price">
                                                                        ...
                                                                        if ($data['total_price'] > 0) {
                                                                            ?>
                                                                            <span class="fw-bolder text-dark">$<?= number_format($data['total_price'], 2, '.', '') ?></span>
                                                                            <?php
                                                                        }
                                                                        ?>
                                                                    </div>
                                                                    ...
                                                                    <div class="m-0">
                                                                        ...
                                                                        foreach ($scopeNames as $scopeID => $name) {
                                                                            ...
                                                                            <div id="kt_cat_<?= $cat . '_' . $index ?>"
                                                                                ...
                                                                                if ($price > 0) {
                                                                                    ?>
                                                                                    <span class="fw-bolder text-dark">$<?= number_format($price, 2, '.', '') ?></span>
                                                                                    <?php
                                                                                }
                                                                                ?>
                                                                            </span>
                                                                                    ...
                                                                                    <div class="text-end">
                                                                                        ...
                                                                                        if ($refines['price'] > 0) {
                                                                                            ?>
                                                                                            <span class="text-dark fw-bolder">Total: $<?= number_format($refines['price'], 2, '.', '') ?></span>
                                                                                            <?php
                                                                                        }
                                                                                        ?>
                                                                                    </div>
                                                ...
                                                <div class="card-footer">
                                                    <span class="text-dark fs-3 fw-bolder text-start">Grand Total</span>
                                                    <div class="badge bg-danger text-wrap fs-3 fw-bolder float-end">
                                                        $<?php echo $project_budget; ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        <!--end::Quote Summary-->
                                        ...
                                        <div class="card" id="kt_chat_messenger">
                                            ...
                                            <div class="card-header collapsible cursor-pointer rotate"
                                                ...
                                                <div class="card-title">
                                                    <!--begin::User-->
                                                    <h3 class="fw-bolder">
                                                        <i class="fa-light fs-4 text-danger fa-comments-question-check"></i>
                                                        Team
                                                        Chat
                                                    </h3>
                                                    <!--end::User-->
                                                ...
                                                <!--begin::Card toolbar-->
                                                <div class="card-toolbar">
                                                    <a class="btn btn-light-danger btn-sm btnLoadContacts"
                                                       href="javascript:void(0)">
                                                        <i class="fa-regular fa-users-medical"></i> Invite Team
                                                    </a>
                                                </div>
                                                <!--end::Card toolbar-->
                                            </div>
                                                    ...
                                                    <div class="scroll-y me-n5 pe-5 h-400px  h-lg-auto"
                                                                ...
                                                                if ($user_id == $author_id) {
																	...
																	<span class="text-muted fs-7 mb-1"
                                                                          data-kt-element="message_datetime"><?= $date . ' ' . $time ?></span>
                                                                            ...
                                                                            <!--begin::Text-->
                                                                            <div
                                                                                    class="p-3 pb-0 rounded bg-light-primary mw-lg-400px text-end">
                                                                                <div
                                                                                        class="text-dark fw-bolder mb-3 <?= $content == '' ? 'd-none' : '' ?>"
																			...
																			<svg xmlns="http://www.w3.org/2000/svg"
                                                                                ...
                                                                                <path
                                                                                        ...
                                                                                        fill="currentColor"/>
                                                                                                            ...
                                                                                                            href="<?= wp_get_attachment_url(get_the_ID()) ?>"
                                                                                                            download
                                                                                                            class="text-dark fw-bolder"><?= basename(get_attached_file(get_the_ID())) ?></a>
                                                                                                    <!--end::Svg Icon-->
                                                                                                </div>
                                                                                                <?php
                                                                                            }
                                                                    ...
                                                                    <div class="d-flex justify-content-start mb-6">
                                                                        ...
                                                                        <div class="d-flex flex-column align-items-start">
                                                                            ...
                                                                            <!--begin::Text-->
                                                                            <div
                                                                                    class="p-3 pb-0 rounded bg-light-info fw-bold mw-lg-400px text-start">
                                                                                <div
                                                                                        class="text-dark fw-bolder mb-3 <?= $content == '' ? 'd-none' : '' ?>"
                                                                                        data-kt-element="message-text"><?= $content ?></div>
                                                                                <!--begin::attachments-->
                                                                                            ...
                                                                                            if (in_array($mime_type, PREVIEW_ALLOWED_IMG_FILE_TYPES)) {
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <a
                                                                                                        ...
                                                                                                        <?= basename(get_attached_file(get_the_ID())) ?>
                                                                                                    </a>
                                                                                                    <!--end::Svg Icon-->
                                                                                                </div>
                                                                                                <?php
                                                        ...
                                                        <div class="d-flex justify-content-end mb-6 d-none"
                                                            ...
                                                            <div class="d-flex flex-column align-items-end">
                                                                ...
                                                                <!--end::User-->
                                                                <!--begin::Text-->
                                                                <div class="p-3 rounded bg-light-primary mw-lg-400px text-end">
                                                                    <div class="text-dark fw-bolrder mb-3"
                                            ...
                                            <div class="card-header collapsible cursor-pointer rotate"
                                                ...
                                                <div class="card-title">
                                                    ...
                                                    <div class="d-flex justify-content-center flex-column me-3">
                                                        ...
                                                        ?>
                                                        <h3 class="fw-bolder"><i
                                                                    class="fa-regular fs-4 text-danger fa-list-check"></i>
                                                            Tasks <span
                                                                    class="badge badge-square badge-light-danger tasks_count"><?= intval($tasks->post_count) ?></span>
                                                        </h3>
                                                    </div>
                                                    <!--end::User-->
                                                </div>
                                                ...
                                                <div class="card-body" id="kt_tasks_body">
                                                    <div class="scroll-y me-n5 pe-5 h-400px h-lg-auto"
                                                        ...
                                                        <div class="d-flex align-items-center mb-6 d-none overlay"
                                                            ...
                                                            <!--begin::Bullet-->
                                                            <span
                                                                    class="bullet bullet-vertical d-flex align-items-center min-h-70px mh-100 bg-primary"></span>
                                                            <!--end::Bullet-->
                                                            <!--begin::Checkbox-->
                                                            <div
                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <div class="d-flex flex-column">
                                                                    ...
                                                                    <div class="text-gray-400 fw-bold fs-7"
                                                                         ...
                                                                         data-bs-placement="top" title="Users assigned"
                                                                         data-kt-element="users"><i
                                            ...
                                            <div class="card-header collapsible cursor-pointer rotate"
                                                ...
                                                <div class="card-title">
                                                    ...
                                                    <div class="d-flex justify-content-center flex-column me-3">
                                                        ...
                                                        ?>
                                                        <h3 class="fw-bolder mb-1"><i
                                                                    class="fa-regular fs-4 text-danger fa-note"></i>
                                                            Notes <span
                                                                    class="badge badge-square badge-light-danger notes_count"><?= intval($notes->post_count) ?></span>
                                                        </h3>
                                                    </div>
                                                    <!--end::User-->
                                                </div>
                                                        ...
                                                        <div class="d-flex flex-stack">
                                                            ...
                                                            <div class="me-2 d-none">
                                                                ...
                                                                <select class="form-select" data-kt-element="viewer">
                                                                    ...
                                                                    <option value="Business">Staff</option>
                                                    ...
                                                    <div class="kt_drawer_note_editor d-none">
                                                        ...
                                                        <div class="d-flex flex-stack">
                                                            ...
                                                            <div class="me-2 d-none">
                                                                ...
                                                                <select class="form-select" data-kt-element="viewer">
                                                                    <option value="all">Everyone</option>
                                                                    <option value="Business">Houseace Staff</option>
                                                                    <option value="Contractor">Tradesperson</option>
                                                                </select>
                                                            </div>
                                                            <!--end::Actions-->
                                ...
                                <div class="row g-9 mb-9">
                                    ...
                                    <div class="col-md-3">
                                        <a href="javascript:void(0)"
                                           ...
                                           data-bs-target="#kt_modal_load_schedules"><i
                                                    class="fa-regular fa-folders text-light"></i> Load a template</a>
                                    </div>
                                </div>
                                <!--end::Row-->
                                <!--begin::Row-->
                            ...
                            <div class="tab-pane fade show <?= $tab == 'project-payments' ? 'active' : '' ?>"
                                ...
                                <div class="row g-9 mb-9">
                                    <div class="col-md-4">
                                        <a href="javascript:void(0)"
                                           class="btn btn-primary fw-bolder w-100 fs-6 px-8 py-4"
                                           id="btnCreatePayment"><i class="fa-light fa-file-invoice text-light"></i> New
                                            Payment</a>
                                    </div>
                                    <div class="col-md-4">
                                        <a href="javascript:void(0)"
                                           class="btn btn-success fw-bolder w-100 fs-6 px-8 py-4"
                                           data-bs-toggle="modal"
                                           data-bs-target="#kt_modal_load_payments"><i
                                                    class="fa-regular fa-folders text-light"></i> Load a templates</a>
                                    </div>
                                </div>
                                <!--end::Row-->
                                <?php
                                ...
                                <div class="card card-flush mt-6 mt-xl-9">
                                    ...
                                    <div class="card-header mt-5">
                                        ...
                                        <div class="card-title flex-column">
                                            <h3 class="fw-bolder mb-1">Project Billing</h3>
                                            <div class="fs-6 text-gray-400">Total
                                                $<?= number_format($payments_total, 2, '.', '') ?>
                                            </div>
                                        </div>
                                        <!--begin::Card title-->
                                        <!--begin::Card toolbar-->
                                        <div class="card-toolbar my-1">
                                            ...
                                            <div class="me-4 my-1">
                                                <select id="kt_filter_payments_orders" name="orders"
                                                    ...
                                                    <option value="" selected="selected">All Payments</option>
                                                    <?php
                            ...
                            <div class="tab-pane fade show <?= $tab == 'project-users' ? 'active' : '' ?>"
                                ...
                                <div class="row g-6 g-xl-9">
                                            ...
                                            <div class="card h-100">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        if ($team_member->id == $client) {
                                                            ?>
                                                            <!--begin::Close-->
                                                            <a href="javascript:void(0)"
                                                               class="btn btn-sm btn-icon btn-active-color-primary"
                                                               data-bs-toggle="modal"
                                                               data-bs-target="#kt_modal_change_client">
                                                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                                                                <i class="bi bi-pencil-fill fs-7 text-gray"></i>
                                                                <!--end::Svg Icon-->
                                                            </a>
                                                            <!--end::Close-->
                                                            <?php
                                                            ...
                                                            <!--begin::Close-->
                                                            <a href="javascript:void(0)"
                                                               class="btn btn-sm btn-icon btn-active-color-danger btnRmUser"
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        ...
                                        <div class="card h-100">
                                            <!--begin::Card body-->
                                            <a class="btnLoadContacts">
                                                <div
                                                        class="card-body d-flex flex-center flex-column pt-12 p-9 position-relative justify-content-center">
                                                    <i class="fa-regular fa-user-plus fs-4x"></i>
                                                    <h3 class="text-dark fw-bolder p-5">
                                                        Add New
                                                    </h3>
                                                    <a class="btn btn-primary btn-sm fw-bolder btnLoadContacts">Invite</a>
                                                </div>
                                            </a>
                                            <!--end::Info-->
                                        </div>
                                    ...
                                    <div class="card-header pt-8">
                                        <div class="card-title">
                                            ...
                                            <button class="ms-2 btn btn-success" data-bs-toggle="modal"
                                                    data-bs-target="#kt_modal_file_upload">Upload Files
                                            </button>
                                        </div>
                                        <!--begin::Card toolbar-->
                                        <div class="card-toolbar">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header card-header-stretch">
                                        ...
                                        <div class="card-toolbar d-flex align-items-center">
                                            <button class="ms-5 btn btn-primary" data-bs-toggle="modal"
                                                    data-bs-target="#kt_modal_add_activity">Add New
                                            </button>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                            ...
                            <div class="tab-pane fade show <?= $tab == 'project-contract' ? 'active' : '' ?>"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header card-header-stretch">
                                        <!--begin::Title-->
                                        <div class="card-title d-flex align-items-center">
                                            <h3 class="fw-bolder m-0 text-gray-800">Contract</h3>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Card head-->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="full_contract">
                                                ...
                                                <a class="btn btn-block btn-success save_contract mt-5">Save
                                                    Contract</a>
                                            </div>
                                            <!--end::Tab panel-->
                                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            if (!aireno_user_left_review_on_project($project_id, $user_id)) {
                                                ?>
                                                <form id="ratingForm" enctype="multipart/form-data" method="post"
                                                      class="mb-10">
                                                    <input type="hidden" name="action" value="aireno_rate_project"/>
                                                    <input type="hidden" name="project_id" value="<?= $project_id ?>"/>
                                                    <h2 class="mb-5">Leave a review</h2>
                                                    <!--begin::Rating-->
                                                    <div class="rating fv-row mb-5">
                                                        <!--begin::Star 1-->
                                                        ...
                                                        <input class="rating-input" name="rating" value="2"
                                                               type="radio" id="kt_rating_input_2"/>
                                                        <!--end::Star 2-->
                                                        ...
                                                        <input class="rating-input" name="rating" value="3"
                                                               type="radio" id="kt_rating_input_3"/>
                                                        <!--end::Star 3-->
                                                        ...
                                                        <input class="rating-input" name="rating" value="4"
                                                               type="radio" id="kt_rating_input_4"/>
                                                        <!--end::Star 4-->
                                                        ...
                                                        <input class="rating-input" name="rating" value="5" checked
                                                               type="radio" id="kt_rating_input_5"/>
                                                        <!--end::Star 5-->
                                                    </div>
                                                    <!--end::Rating-->
                                                    <!--begin::Assigned users-->
                                                    <div class="d-flex mb-5 fv-row flex-column">
                                                        <!--begin::Select2-->
                                                        <select class="form-select" name="receivers[]"
                                                                data-control="select2" multiple
                                                                data-placeholder="Assign users">
                                                            <?php
                                                            $receivers = aireno_get_project_users_for_review($project_id, $user_id);
                                                            foreach ($receivers as $receiver) {
                                                                $receiver_userdata = aireno_get_userdata($receiver);
                                                                ?>
                                                                <option
                                                                        value="<?= $receiver_userdata->id ?>">
                                                                    <?= $receiver_userdata->display_name ?></option>
                                                                <?php
                                                            }
                                                            ?>
                                                        </select>
                                                    ...
                                                    <div class="fv-row mb-5">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <!--begin::Option-->
                                                                <textarea class="w-100 form-control" rows="7"
                                                    ...
                                                    <div class="flex-center">
                                                        <!--begin::Button-->
                                                        <button type="submit" id="btnRatingSubmit"
                                            ...
                                            foreach ($reviews as $review) {
                                                ...
                                                ?>
                                                <div class="mb-6 border-top pt-6">
                                                    <h3 class="mb-2">Review
                                                        for <?= $receiver_userdata->display_name ?></h3>
    ...
    <!--begin::Modal - Edit Project Fee-->
    <div class="modal fade" id="kt_modal_manage_project_fee" tabindex="-1"
         aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" id="kt_modal_manage_project_fee_form">
                    <!--begin::Modal header-->
                    <div class="modal-header" id="kt_modal_manage_project_fee_header">
                        <!--begin::Modal title-->
                        <h2>Manage Project Fee</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7"
                             id="kt_modal_manage_project_fee_scroll" data-kt-scroll="true"
                             data-kt-scroll-activate="{default: false, lg: true}"
                             data-kt-scroll-max-height="auto"
                             data-kt-scroll-dependencies="#kt_modal_manage_project_fee_header"
                             data-kt-scroll-wrappers="#kt_modal_manage_project_fee_scroll"
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-md-12 fv-row">
                                    <!--begin::Label-->
                                    <label class="required fs-5 fw-bold mb-2">Project Fee</label>
                                    <!--end::Label-->
                                    <?php
                                    $project_fee = number_format(floatval(get_field('fee', $project_id)), 2);
                                    ?>
                                    <!--begin::Input-->
                                    <input type="number" class="form-control form-control-solid"
                                           placeholder="" name="project-fee" min="0" max="100"
                                           value="<?= $project_fee ?>"/>
                                    <!--end::Input-->
                                </div>
                                <!--end::Col-->
                    ...
                    <div class="modal-footer flex-center">
                        <!--begin::Button-->
                        <button type="reset" id="kt_modal_manage_project_fee_cancel"
                                class="btn btn-light me-3">Discard
                        </button>
                        <!--end::Button-->
                        <!--begin::Button-->
                        <button type="submit" id="kt_modal_manage_project_fee_submit"
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <ul class="nav nav-pills nav-pills-custom justify-content-center mb-3" role="tablist">
                            ...
                            <li class="nav-item mb-3 me-3 me-lg-6" role="presentation">
                                <!--begin::Link-->
                                <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-danger flex-column overflow-hidden w-80px h-85px pt-5 pb-2 active"
                                   id="bath_link" data-bs-toggle="tab" href="#bath_tab" aria-selected="true" role="tab"
                                   tabindex="-1">
                                    <!--begin::Icon-->
                            ...
                            <li class="nav-item mb-3 me-3 me-lg-6" role="presentation">
                                ...
                                <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-danger flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
                                   id="kitchen_link" data-bs-toggle="tab" href="#kitchen_tab" role="tab"
                                   aria-selected="false">
                                    <!--begin::Icon-->
                                    <div class="nav-icon mb-3">
                            ...
                            <li class="nav-item mb-3 me-3 me-lg-6" role="presentation">
                                <!--begin::Link-->
                                <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-danger flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
                                   id="full_link" data-bs-toggle="tab" href="#full_tab" role="tab">
                                    <!--begin::Icon-->
                                    <div class="nav-icon mb-3">
                          ...
                          Full Reno                       
                            ...
                            <li class="nav-item mb-3 me-3 me-lg-6" role="presentation">
                                <!--begin::Link-->
                                <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-danger flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
                                   id="extend_link" data-bs-toggle="tab" href="#extend_tab" role="tab">
                                    <!--begin::Icon-->
                                    <div class="nav-icon mb-3">
                          ...
                          Extensions                      
                            ...
                            <li class="nav-item mb-3 me-3 me-lg-6" role="presentation">
                                <!--begin::Link-->
                                <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-danger flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
                                   id="laundry_link" data-bs-toggle="tab" href="#laundry_tab" role="tab">
                                    <!--begin::Icon-->
                                    <div class="nav-icon mb-3">
                            ...
                            <li class="nav-item mb-3 me-3 me-lg-6" role="presentation">
                                <!--begin::Link-->
                                <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-danger flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
                                   id="general_link" data-bs-toggle="tab" href="#general_tab" role="tab">
                                    <!--begin::Icon-->
                                    <div class="nav-icon mb-3">
                        ...
                        <!--begin::Tab Content-->
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="bath_tab" role="tabpanel"
                                 aria-labelledby="#bath_link">
                                <!--begin::Row-->
                                <div class="row">
                                    <!--begin::Col-->
                                    <div class="col-lg-6 mb-10 mb-lg-0">
                                        <ul class="nav flex-column nav-pills nav-fill" id="tabset">
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6 active"
                                                   id="bathtab1" data-bs-toggle="pill" data-bs-target="#bath1"
                                                   type="button" role="tab" aria-controls="bath1" aria-selected="true">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                                        <div class="flex-grow-1">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="bathtab2" data-bs-toggle="pill" data-bs-target="#bath2"
                                                   type="button" role="tab" aria-controls="bath2" aria-selected="false">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                                        <div class="flex-grow-1">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="bathtab3" data-bs-toggle="pill" data-bs-target="#bath3"
                                                   type="button" role="tab" aria-controls="bath3" aria-selected="false">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                                        <div class="flex-grow-1">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="bathtab4" data-bs-toggle="tab" data-bs-target="#bath4"
                                                   type="button" role="tab" aria-controls="bath4" aria-selected="true">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                                        <div class="flex-grow-1">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="tab-content rounded h-100 bg-light p-10" id="bathtabset">
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade show active" id="bath1" role="tabpanel"
                                                 aria-labelledby="bathtab1">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        <a class="btn btn-danger btn-lg fw-bolder asp-product-loader"
                                                           href="javascript:void(0)">Buy Planning Upgrade</a>
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Planning Upgrade" product_id="932" button_text="Buy Planning Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!--end::Tab Pane-->
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade" id="bath2" role="tabpanel"
                                                 aria-labelledby="bathtab2">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        <a class="btn btn-danger btn-lg fw-bolder asp-product-loader"
                                                           href="javascript:void(0)">Buy Design Upgrade</a>
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Design Upgrade" product_id="790" button_text="Buy Design Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!--end::Tab Pane-->
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade" id="bath3" role="tabpanel"
                                                 aria-labelledby="bathtab3">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
                                                        We'll research and background check local contractors on your
                                                        behalf
                                                    </div>
                                                </div>
                                                <!--end::Heading-->
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        <a class="btn btn-danger btn-lg fw-bolder asp-product-loader"
                                                           href="javascript:void(0)">Buy Matching Upgrade</a>
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Matching Upgrade" product_id="933" button_text="Buy Matching Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!--end::Tab Pane-->
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade" id="bath4" role="tabpanel"
                                                 aria-labelledby="bathtab4">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        <a class="btn btn-danger btn-lg fw-bolder asp-product-loader"
                                                           href="javascript:void(0)">Buy Estimate Verification Upgrade</a>
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Estimate Verification Upgrade" product_id="337" button_text="Buy Estimate Verification Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-10 mb-lg-0">
                                        <ul class="nav flex-column nav-pills nav-fill" id="tabset">
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6 active"
                                                   id="kitchentab1" data-bs-toggle="pill" data-bs-target="#kitchen1"
                                                   type="button" role="tab" aria-controls="kitchen1"
                                                   aria-selected="true">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="kitchentab2" data-bs-toggle="pill" data-bs-target="#kitchen2"
                                                   type="button" role="tab" aria-controls="kitchen2"
                                                   aria-selected="false">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="kitchentab3" data-bs-toggle="pill" data-bs-target="#kitchen3"
                                                   type="button" role="tab" aria-controls="kitchen3"
                                                   aria-selected="false">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="kitchentab4" data-bs-toggle="tab" data-bs-target="#kitchen4"
                                                   type="button" role="tab" aria-controls="kitchen4"
                                                   aria-selected="false">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="tab-content rounded h-100 bg-light p-10" id="bathtabset">
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade show active" id="kitchen1" role="tabpanel"
                                                 aria-labelledby="kitchentab1">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        ...
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Planning Upgrade" product_id="937" button_text="Buy Planning Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!--end::Tab Pane-->
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade" id="kitchen2" role="tabpanel"
                                                 aria-labelledby="kitchentab2">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        ...
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Design Upgrade" product_id="792" button_text="Buy Design Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!--end::Tab Pane-->
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade" id="kitchen3" role="tabpanel"
                                                 aria-labelledby="kitchentab3">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                            ...
                                            <!--end::Tab Pane-->
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade" id="kitchen4" role="tabpanel"
                                                 aria-labelledby="kitchentab4">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        ...
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Estimate Verification Upgrade" product_id="785" button_text="Buy Estimate Verification Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-10 mb-lg-0">
                                        <ul class="nav flex-column nav-pills nav-fill" id="tabset">
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6 active"
                                                   id="fulltab1" data-bs-toggle="pill" data-bs-target="#full1"
                                                   type="button" role="tab" aria-controls="full1" aria-selected="true">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                                        <div class="flex-grow-1">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="fulltab2" data-bs-toggle="pill" data-bs-target="#full2"
                                                   type="button" role="tab" aria-controls="full2" aria-selected="false">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                                        <div class="flex-grow-1">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="fulltab3" data-bs-toggle="pill" data-bs-target="#full3"
                                                   type="button" role="tab" aria-controls="full3" aria-selected="false">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                                        <div class="flex-grow-1">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="fulltab4" data-bs-toggle="tab" data-bs-target="#full4"
                                                   type="button" role="tab" aria-controls="full4" aria-selected="false">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                                        <div class="flex-grow-1">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="tab-content rounded h-100 bg-light p-10" id="bathtabset">
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade show active" id="full1" role="tabpanel"
                                                 aria-labelledby="fulltab1">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        ...
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Planning Upgrade" product_id="938" button_text="Buy Planning Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!--end::Tab Pane-->
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade" id="full2" role="tabpanel"
                                                 aria-labelledby="fulltab2">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        ...
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Design Upgrade" product_id="793" button_text="Buy Design Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!--end::Tab Pane-->
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade" id="full3" role="tabpanel"
                                                 aria-labelledby="fulltab3">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                            ...
                                            <!--end::Tab Pane-->
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade" id="full4" role="tabpanel"
                                                 aria-labelledby="fulltab4">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        ...
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Estimate Verification Upgrade" product_id="942" button_text="Buy Estimate Verification Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-10 mb-lg-0">
                                        <ul class="nav flex-column nav-pills nav-fill" id="tabset">
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6 active"
                                                   id="extendtab1" data-bs-toggle="pill" data-bs-target="#extend1"
                                                   type="button" role="tab" aria-controls="full1" aria-selected="true">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="extendtab2" data-bs-toggle="pill" data-bs-target="#extend2"
                                                   type="button" role="tab" aria-controls="extend2"
                                                   aria-selected="false">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="extendtab3" data-bs-toggle="pill" data-bs-target="#extend3"
                                                   type="button" role="tab" aria-controls="extend3"
                                                   aria-selected="false">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="extendtab4" data-bs-toggle="tab" data-bs-target="#extend4"
                                                   type="button" role="tab" aria-controls="extend4"
                                                   aria-selected="false">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="tab-content rounded h-100 bg-light p-10" id="bathtabset">
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade show active" id="extend1" role="tabpanel"
                                                 aria-labelledby="extendtab1">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        ...
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Planning Upgrade" product_id="943" button_text="Buy Planning Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        ...
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Design Upgrade" product_id="944" button_text="Buy Design Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!--end::Tab Pane-->
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade" id="extend3" role="tabpanel"
                                                 aria-labelledby="extendtab3">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                            ...
                                            <!--end::Tab Pane-->
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade" id="extend4" role="tabpanel"
                                                 aria-labelledby="extendtab4">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        ...
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Estimate Verification Upgrade" product_id="945" button_text="Buy Estimate Verification Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-10 mb-lg-0">
                                        <ul class="nav flex-column nav-pills nav-fill" id="tabset">
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6 active"
                                                   id="laundrytab1" data-bs-toggle="pill" data-bs-target="#laundry1"
                                                   type="button" role="tab" aria-controls="laundry1"
                                                   aria-selected="true">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="laundrytab2" data-bs-toggle="pill" data-bs-target="#laundry2"
                                                   type="button" role="tab" aria-controls="laundry2"
                                                   aria-selected="false">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="laundrytab3" data-bs-toggle="pill" data-bs-target="#laundry3"
                                                   type="button" role="tab" aria-controls="laundry3"
                                                   aria-selected="false">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="laundrytab4" data-bs-toggle="tab" data-bs-target="#laundry4"
                                                   type="button" role="tab" aria-controls="laundry4"
                                                   aria-selected="false">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="tab-content rounded h-100 bg-light p-10" id="bathtabset">
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade show active" id="laundry1" role="tabpanel"
                                                 aria-labelledby="laundrytab1">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        ...
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Planning Upgrade" product_id="948" button_text="Buy Planning Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!--end::Tab Pane-->
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade" id="laundry2" role="tabpanel"
                                                 aria-labelledby="laundrytab2">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        ...
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Design Upgrade" product_id="947" button_text="Buy Design Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                            ...
                                            <!--end::Tab Pane-->
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade" id="laundry4" role="tabpanel"
                                                 aria-labelledby="laundrytab4">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        ...
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Estimate Verification Upgrade" product_id="946" button_text="Buy Estimate Verification Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-10 mb-lg-0">
                                        <ul class="nav flex-column nav-pills nav-fill" id="tabset">
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6 active"
                                                   id="generaltab1" data-bs-toggle="pill" data-bs-target="#general1"
                                                   type="button" role="tab" aria-controls="general1"
                                                   aria-selected="true">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="generaltab2" data-bs-toggle="pill" data-bs-target="#general2"
                                                   type="button" role="tab" aria-controls="general2"
                                                   aria-selected="false">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="generaltab3" data-bs-toggle="pill" data-bs-target="#general3"
                                                   type="button" role="tab" aria-controls="general3"
                                                   aria-selected="false">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6"
                                                   id="generaltab4" data-bs-toggle="tab" data-bs-target="#general4"
                                                   type="button" role="tab" aria-controls="general4"
                                                   aria-selected="false">
                                                    <!--end::Description-->
                                                    <div class="d-flex align-items-center me-2">
                                                        <!--begin::Info-->
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="tab-content rounded h-100 bg-light p-10" id="bathtabset">
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade show active" id="general1" role="tabpanel"
                                                 aria-labelledby="generaltab1">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        ...
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Planning Upgrade" product_id="951" button_text="Buy Planning Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!--end::Tab Pane-->
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade" id="general2" role="tabpanel"
                                                 aria-labelledby="generaltab2">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        ...
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Design Upgrade" product_id="953" button_text="Buy Design Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!--end::Tab Pane-->
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade" id="general3" role="tabpanel"
                                                 aria-labelledby="generaltab3">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                            ...
                                            <!--end::Tab Pane-->
                                            <!--begin::Tab Pane-->
                                            <div class="tab-pane fade" id="general4" role="tabpanel"
                                                 aria-labelledby="generaltab4">
                                                <!--begin::Heading-->
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s included?</h2>
                                                    <div class="text-muted fw-semibold">
...
<path d="M10.4343 12.4343L8.75 10.75C8.33579 10.3358 7.66421 10.3358 7.25 10.75C6.83579 11.1642 6.83579 11.8358 7.25 12.25L10.2929 15.2929C10.6834 15.6834 11.3166 15.6834 11.7071 15.2929L17.25 9.75C17.6642 9.33579 17.6642 8.66421 17.25 8.25C16.8358 7.83579 16.1642 7.83579 15.75 8.25L11.5657 12.4343C11.2533 12.7467 10.7467 12.7467 10.4343 12.4343Z"
      fill="currentColor"></path>
                                                    ...
                                                    <div class="d-flex flex-column mb-7">
                                                        ...
                                                        <div class="d-none asp-product-container">
                                                            <?php
                                                            echo do_shortcode('[accept_stripe_payment name="Estimate Verification Upgrade" product_id="952" button_text="Buy Estimate Verification Upgrade" project_id="' . $project_id . '"]');
                                                            ?>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <!--begin::Modal - Project Status-->
    <div class="modal fade" id="kt_modal_manage_project_status"
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <form class="form" action="#"
                      id="kt_modal_manage_project_status_form">
                    <!--begin::Modal header-->
                    <div class="modal-header" id="kt_modal_manage_project_status_header">
                        <!--begin::Modal title-->
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7">
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-md-12 fv-row">
                                    <!--begin::Label-->
                                    <label class="required fs-5 fw-bold mb-2">Change Status</label>
                                    <!--end::Label-->
                                    <!--begin::Select2-->
                                    <select class="form-select mb-2" name="status"
                                        ...
                                        <option value="quote"
                                            <?= ($projectStatus->status == 'quote') ? 'selected' : '' ?>>
                                            Estimate
                                        </option>
                                        <option value="active"
                                            <?= ($projectStatus->status == 'active') ? 'selected' : '' ?>>
                                            Reviewing
                                        </option>
                                        <option value="updated"
                                            <?= ($projectStatus->status == 'updated') ? 'selected' : '' ?>>
                                            Updated Estimate
                                        </option>
                                        <option value="booked"
                                            <?= ($projectStatus->status == 'booked') ? 'selected' : '' ?>>
                                            Site Visit
                                        </option>
                                        <option value="pending"
                                            <?= ($projectStatus->status == 'pending') ? 'selected' : '' ?>>
                                            Final Quote - Sends quote for approval
                                        </option>
                                        <option value="live"
                                            <?= ($projectStatus->status == 'live') ? 'selected' : '' ?>>
                                            Working - Accepted quote
                                        </option>
                                        <option value="completed"
                                            <?= ($projectStatus->status == 'completed') ? 'selected' : '' ?>>
                                            Completed
                                        </option>
                                        <option value="cancelled"
                                            <?= ($projectStatus->status == 'cancelled') ? 'selected' : '' ?>>
                                            Cancelled
                                        </option>
                                    </select>
                                    <!--end::Select2-->
                    ...
                    <div class="modal-footer flex-center">
                        <!--begin::Button-->
                        <button type="reset" id="kt_modal_manage_project_status_cancel"
                                class="btn btn-light me-3">Discard
                        </button>
                        <!--end::Button-->
                        <!--begin::Button-->
                        <button type="submit" id="kt_modal_manage_project_status_submit"
                                class="btn btn-primary">
                            <span class="indicator-label">Save</span> <span
                                    class="indicator-progress">Please wait... <span
                                        class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7">
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-md-12 fv-row">
                                    <!--begin::Label-->
                                    <label class="required fs-5 fw-bold mb-2">Why are you closing
                                        this project?</label>
                                    <!--end::Label-->
                                    <!--begin::Select2-->
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7"
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-md-12 fv-row">
                                    <!--begin::Label-->
                                    <label class="required fs-5 fw-bold mb-2">Project Start Date</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll"
                            ...
                            <div
                                ...
                                <span class="svg-icon svg-icon-2tx svg-icon-warning me-4"> <svg
                                    ...
                                    <rect opacity="0.3" x="2" y="2"
                                          width="20" height="20" rx="10" fill="currentColor"/>
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    ...
                                    <div class="fw-bold">
                                        ...
                                        <div class="fs-6 text-gray-700">
                                            Updating address may affter to your <a href="javascript:void(0)">Tax
                                                Location</a>
                                        </div>
                                    </div>
                                    <!--end::Content-->
                            ...
                            <div class="d-flex flex-column mb-5 fv-row">
                                <!--begin::Label-->
                                <label class="d-flex align-items-center fs-5 fw-bold mb-2"> <span
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <label
                                        ...
                                        <!--begin::Input--> <input class="form-check-input"
                                                                   name="billing" type="checkbox" value="1"
                                                                   checked="checked"/> <!--end::Input-->
                                        <!--begin::Label--> <span
                                                class="form-check-label fw-bold text-muted">Yes</span> <!--end::Label-->
                                    </label>
                                    <!--end::Switch-->
                                </div>
                                <!--begin::Wrapper-->
        ...
        <div class="modal-dialog mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y pt-0 pb-5">
                    <!--begin::project user add form-->
                    <form id="search_project_pending_users_form" method="post"
                          enctype="multipart/form-data">
                        <input type="hidden" name="action"
                               value="aireno_add_member_to_project"/>
                        <!--begin::Content-->
                        <div class="text-center mb-7">
                            <h1 class="mb-3">Add Users</h1>
                            <div class="text-muted fw-bold fs-5">Add users to your
                                project
                            </div>
                        </div>
                        <!--end::Content-->
                        ...
                        <div id="kt_modal_users_search_handler"
                            ...
                            <div class="d-flex align-items-center position-relative">
                                ...
                                <input type="text" class="form-control form-control-solid ps-15"
                                       placeholder="Search Users" id="search_project_pending_users">
                            </div>
                            <!--end::Search-->
                            ...
                            <div class="py-5">
                                <!--begin::Users-->
                                <div class="mh-375px scroll-y me-n7 pe-7 project_pending_members"
                                     data-kt-search-element="results">
                                </div>
                                <!--end::Users-->

                                <!--Begin:Search Result Template-->
                                <div class="p-3 border border-danger border-dashed rounded d-flex w-100 justify-content-between flex-row d-none mb-3 cursor-pointer"
                                     data-kt-element="template">
                                    <div class="d-flex">
                                        <div class="me-3">
                                            <img class="h-50px" src="" alt="avatar"/>
                                        </div>
                                        <div class="d-flex flex-column justify-content-around me-3">
                                            ...
                                            <span class="fw-bolder"
                                                  data-kt-element="email">vasiledarmaz0025@hotmail.com</span>
                                        </div>
                                    </div>
                                    <div class="d-flex">
                                        <div class="me-3">
                                            <select class="form-select">
                                                <?php
                                                if (is_head($user_id) || current_user_can('manage_options')) {
                                                    ?>
                                ...
                                <div class="d-flex flex-center mt-5">
                                    <a class="btn btn-danger me-3" href="javascript:void(0)" data-bs-toggle="modal"
                                       data-bs-target="#kt_modal_new_target">Invite New</a>
                                </div>
                                <!--end::Actions-->
    ...
    <!--begin::Modal - Accept Project-->
    <div class="modal fade" id="kt_modal_accept_project" tabindex="-1"
         aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <!--begin::Modal content-->
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="#" id="kt_modal_accept_project_form">
                    <!--begin::Modal header-->
                    <div class="modal-header" id="kt_modal_accept_project_header">
                        <!--begin::Modal title-->
                        <h2>Accept Quote</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                    ...
                    <div class="modal-body py-5 px-7">
                        <!--begin::Scroll-->
                        <div class="border-dark border-1 mb-7 border-solid scroll-y pe-3"
                             style="border-style: solid" id="kt_modal_accept_project_scroll"
                             data-kt-scroll="true"
                             data-kt-scroll-activate="{default: false, lg: true}"
                             data-kt-scroll-max-height="auto"
                             data-kt-scroll-dependencies="#kt_modal_new_address_header"
                            ...
                            <div class="row mb-2">
                                <div class="col-md-12">
                                    <!--begin::Content-->
                                    <div class="fw-bold">
                                        <h4 class="my-5 ps-2 text-dark-900 fw-bolder">Terms & Conditions</h4>

                                        <div class="ps-2">
                                            <?= apply_filters('the_content', get_field('contract', $project_id)); ?>
                                        </div>
                                    </div>
                                    <!--end::Content-->
                                </div>
                        ...
                        <div class="fv-row">
                            <div class="form-check form-check-custom form-check-solid mb-2">
                                <label class="form-check-label text-dark fw-bolder"> <input
                                            class="form-check-input me-2" type="checkbox"
                                            name="client_approve" value="1"> By checking this you agree to
                    ...
                    <div class="modal-footer flex-center">
                        <!--begin::Button-->
                        <button type="reset" id="kt_modal_accept_project_cancel"
                                class="btn btn-light me-3">Cancel
                        </button>
                        <!--end::Button-->
                        <!--begin::Button-->
                        <button type="submit" id="kt_modal_accept_project_submit"
                                class="btn btn-primary">
                            <span class="indicator-label">Accept Quote</span> <span
                                    class="indicator-progress">Please wait... <span
    ...
    <!--end::Modal - Accept Project-->

    <!--begin::Modal - View Project Users-->
        ...
        <div class="modal-dialog mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y pt-0 pb-5">
                    ...
                    <div class="text-center mb-7">
                        <!--begin::Title-->
                        <h1 class="mb-3">Manage Project Users</h1>
                        <!--end::Title-->
                    </div>
                    <!--end::Heading-->
                    <!--begin::Users-->
                            ...
                            foreach ($team_members as $team_member) {
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-35px symbol-circle">
                                            <img alt="Pic" src="<?= $team_member->avatar ?>"/>
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-6">
                                            <!--begin::Name-->
                                            <a href="javascript:void(0)"
                                               class="d-flex align-items-center fs-5 fw-bolder text-dark text-hover-primary"><?= $team_member->display_name ?>
                                                <?php
                                                $badge_class = ($team_member->user_type == 'Business') ? 'badge-success' : '';
                                                switch ($team_member->user_type) {
                                                    case 'Client':
                                                        $badge_class = 'badge-warning';
                                                        break;
                                                    case 'Business':
                                                ...
                                                ?>
                                                <span
                                                        class="badge <?= $badge_class ?> badge-light fs-8 fw-bold ms-2"><?= $team_member->user_type ?></span></a>
                                            <!--end::Name-->
                                            <!--begin::Email-->
                                            <div class="fw-bold text-muted"><?= $team_member->email ?></div>
                                            <!--end::Email-->
                                        </div>
                                        <!--end::Details-->
                                    </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="text-end">
                                            <a href="javascript:void(0)"
                                               class="aireno-rm-team-member fs-5 fw-bolder text-dark"
                                               data-user-id="<?= $team_member->id ?>"> <span
                                                        class="svg-icon svg-icon-1"> <svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none">
                                                <rect opacity="0.5"
                                                      x="6" y="17.3137" width="16" height="2" rx="1"
                    ...
                    <div class="d-flex flex-center mt-15">
                        ...
                        <button type="submit" id="kt_modal_users_search_submit"
                                ...
                                data-bs-target="#kt_modal_users_search">Add New User
                        </button>
                    </div>
                    <!--end::Actions-->
                </div>
    ...
    <!--end::Modal - View Project Users-->

    <!--begin::Modal - New Schedule-->
    <div class="modal fade" id="kt_modal_new_schedule" tabindex="-1"
         aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <!--begin::Modal content-->
            <div class="modal-content rounded">
                ...
                <!--begin::Modal header-->
                <!--begin::Modal body-->
                <div class="modal-body scroll-y pt-0 p-15">
                    <!--begin:Form-->
                    <form id="kt_modal_new_schedule_form" class="form" method="post">
                        <input type="hidden" name="action" value="aireno_add_schedule"/> <input
                                type="hidden" name="project_id" value="<?= $project_id ?>"> <input
                                type="hidden" name="schedule_id" value="">
                        <!--begin::Heading-->
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">Add New Schedule</h1>
                            <!--end::Title-->
                        </div>
                        <!--end::Heading-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2"> <span
                                        class="required">Title</span> <i
                                        class="fas fa-exclamation-circle ms-2 fs-7"
                                        data-bs-toggle="tooltip"
                                        title="Specify a schedule name for future usage and reference"></i>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid"
                                   placeholder="Enter Schedule Title" name="schedule_title"/>
                        </div>
                        <!--end::Input group-->
                        <!--begin::schedule duration-->
                        <div class="row g-9 mb-8">
                            <div class="col-md-6 fv-row">
                                <label class="fs-6 fw-bold mb-2 required">Duration (days)</label> <input
                                        type="number" min="1" class="form-control form-control-solid"
                                        name="schedule_duration" placeholder="Duration"/>
                            </div>
                            <div class="col-md-6 fv-row">
                                <label class="fs-6 fw-bold mb-2 required">Status</label> <select
                                        class="form-control form-control-solid" name="schedule_status">
                                    <option value="0">Yet to Start</option>
                        ...
                        <!--end::schedule duration-->
                        <!--begin::Details-->
                        <div class="d-flex flex-column mb-8 fv-row">
                            <label class="fs-6 fw-bold mb-2 required">Schedule Details</label>
                            <textarea class="form-control form-control-solid" rows="3"
                                      name="schedule_details" placeholder="Type Schedule Details"></textarea>
                        </div>
                        <!--end::Details-->
                        <!--begin::Tasks-->
                        <div class="d-flex flex-column mb-8">
                            <label class="fs-6 fw-bold mb-2">Tasks</label>
                            <div class="d-flex flex-column schedule-tasks">
                                <div
                                        class="d-flex flex-row align-items-center mb-2 schedule-task d-none"
                                        data-kt-element="schedule-task-template">
                                    <input type="checkbox" class="form-check-input me-3"> <input
                                            type="text" class="form-control form-control-solid"
                                            placeholder="Task"> <a
                                            class="btn btn-flush btn-active-light-primary ms-2"
                                            data-kt-element="schedule-remove-task"> <i
                                                class="bi bi-x-circle fs-2 text-danger"></i>
                                    </a> <a class="btn btn-flush btn-active-light-primary ms-2"
                                            data-kt-element="schedule-add-task"> <i
                                                class="bi bi-plus-circle fs-2 text-success"></i>
                                    </a>
                                </div>
                                <div
                                        class="d-flex flex-row align-items-center schedule-task mb-2">
                                    <input type="checkbox" name="schedule_tasks_completed0"
                                           class="form-check-input me-3"> <input type="text"
                                                                                 name="schedule_tasks[]"
                        ...
                        <div class="text-center">
                            <button type="reset" id="kt_modal_new_schedule_cancel"
                                    class="btn btn-light me-3">Cancel
                            </button>
                            <button type="submit" id="kt_modal_new_schedule_submit"
                                    class="btn btn-primary">
                                <span class="indicator-label">Submit</span> <span
                                        class="indicator-progress">Please wait... <span
                                            class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
    ...
    <!--end::Modal - New Schedule-->

    <!--begin::Modal - Create Schedules from tmeplate-->
    <div class="modal fade" id="kt_modal_load_schedules" tabindex="-1"
         aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <!--begin::Modal content-->
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" id="kt_modal_load_schedules_form">
                    <!--begin::Modal header-->
                    <div class="modal-header text-center"
                         id="kt_modal_load_schedules_header">
                        <!--begin::Modal title-->
                        <h2 class="w-100">Load Schedules</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                        <div class="btn btn-sm btn-icon btn-active-color-primary"
                             data-bs-dismiss="modal">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <!--begin::Scroll-->
                        <div class="scroll-y me-n7 pe-7"
                             id="kt_modal_load_schedules_scroll">
                            <!--begin::Input group-->
                            <div class="row mb-5">
                                <!--begin::Col-->
                                <div class="col-md-12 fv-row">
                                    <!--begin::Label-->
                                    <label class="required fs-5 fw-bold mb-3">Choose a schedule
                                        template</label>
                                    <!--end::Label-->
                                    <!--begin::Select-->
                                    <?php
                                    ...
                                    $args = array(
                                        'post_type' => AIRENO_CPT_SCHEDULE_TEMPLATE,
                                        'posts_per_page' => -1,
                                        'post_status' => array(
                                            'publish'
                                        )
                                    );
                                    $schedule_templates_query = new WP_Query($args);
                                    if ($schedule_templates_query->have_posts()) {
                                        while ($schedule_templates_query->have_posts()) {
                                            $schedule_templates_query->the_post();
                                            $schedule_templates[get_the_ID()] = get_the_title();
                                        }
                                    }
                                    wp_reset_query();
                                    if (count($schedule_templates) > 0) {
                                        ...
                                        <select
                                            ...
                                            <?php
                                            foreach ($schedule_templates as $st_ID => $st_title) {
                                                ?>
                    ...
                    <div class="modal-footer flex-center">
                        <!--begin::Button-->
                        <button type="reset" id="kt_modal_load_schedules_cancel"
                                class="btn btn-light me-3">Cancel
                        </button>
                        <!--end::Button-->
                        <!--begin::Button-->
                        <button type="submit" id="kt_modal_load_schedules_submit"
                                class="btn btn-primary">
                            <span class="indicator-label">Load Schedules</span> <span
                                    class="indicator-progress">Please wait... <span
                                        class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                        </button>
                        <!--end::Button-->
    ...
    <!--end::Modal - Create Schedules from tmeplate-->

    <!--begin::Modal - New Payment-->
    <div class="modal fade" id="kt_modal_new_payment" tabindex="-1"
         aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <!--begin::Modal content-->
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form id="kt_modal_new_payment_form" class="form" method="post">
                        <input type="hidden" name="action" value="aireno_add_payment"/> <input
                                type="hidden" name="project_id" value="<?= $project_id ?>"> <input
                                type="hidden" name="payment_id" value="">
                        <!--begin::Heading-->
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">Add(Edit) Payment</h1>
                            <!--end::Title-->
                        </div>
                        <!--end::Heading-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2"> <span
                                        ...
                                        class="fas fa-exclamation-circle ms-2 fs-7"
                                        data-bs-toggle="tooltip"
                                        title="Specify a payment title for future usage and reference"></i>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid"
                                   placeholder="Enter Payment Title" name="payment_title"/>
                        </div>
                        <!--end::Input group-->
                        <!--begin::schedule duration-->
                        <div class="row g-9 mb-8">
                            <div class="col-md-6 fv-row">
                                <!--begin::Label-->
                                <label class="required fs-6 fw-bold mb-2 required">Amount</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="number" class="form-control form-control-solid"
                                       placeholder="" name="payment_amount" value=""/>
                                <!--end::Input-->
                            </div>
                            <!--begin::User-->
                            <div class="col-md-6 fv-row">
                                <label class="fs-6 fw-bold mb-2 required">Assigned User</label>
                                <select data-control="select2" data-hide-search="true" name="payment_user"
                                        class="form-control form-control-solid">
                                    <option value="">Assign an User</option>
                                    <?php
                                    foreach ($team_members as $team_member) {
                                        ?>
                                        <option value="<?= $team_member->id ?>"><?= $team_member->display_name ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <textarea class="form-control form-control-solid" rows="3"
                                      name="payment_description" placeholder="Type Payment Description"></textarea>
                        </div>
                        <!--end::Details-->
                        <!--begin::Actions-->
                        <div class="text-center">
                            <button type="reset" id="kt_modal_new_payment_cancel"
                                    class="btn btn-light me-3">Cancel
                            </button>
                            <button type="submit" id="kt_modal_new_payment_submit"
                                    class="btn btn-primary">
                                <span class="indicator-label">Submit</span> <span
                                        class="indicator-progress">Please wait... <span
                                            class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
    ...
    <!--begin::Modal - Create Payments from tmeplate-->
    <div class="modal fade" id="kt_modal_load_payments" tabindex="-1"
         aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <!--begin::Modal content-->
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" id="kt_modal_load_payments_form">
                    <!--begin::Modal header-->
                    <div class="modal-header text-center"
                         id="kt_modal_load_payments_header">
                        <!--begin::Modal title-->
                        <h2 class="w-100">Load Payments</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                        <div class="btn btn-sm btn-icon btn-active-color-primary"
                             data-bs-dismiss="modal">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <!--begin::Scroll-->
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_load_payments_scroll">
                            <!--begin::Input group-->
                            <div class="row mb-5">
                                <!--begin::Col-->
                                <div class="col-md-12 fv-row">
                                    <!--begin::Label-->
                                    <label class="required fs-5 fw-bold mb-3">Choose a payment
                                        template</label>
                                    <!--end::Label-->
                                    <!--begin::Select-->
                                    <?php
                                    $pt_templates = array();
                                    $args = array(
                                        'post_type' => AIRENO_CPT_PAYMENT_TEMPLATE,
                                        'posts_per_page' => -1,
                                        'post_status' => array(
                                            'publish'
                                        )
                                    );
                                    $payment_templates_query = new WP_Query($args);
                                    if ($payment_templates_query->have_posts()) {
                                        while ($payment_templates_query->have_posts()) {
                                            $payment_templates_query->the_post();
                                            $pt_templates[get_the_ID()] = get_the_title();
                                        }
                                    }
                                    wp_reset_query();
                                    if (count($pt_templates) > 0) {
                                        ?>
                                        <select class="form-control form-control-solid cursor-pointer"
                                                name="pt-template" data-control="select2" data-hide-search="true">
                                            <option value="">Select a payment template</option>
                                            <?php
                                            foreach ($pt_templates as $pt_ID => $pt_title) {
                                                ?>
                                                <option value="<?= $pt_ID ?>"><?= $pt_title ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                    ...
                    <div class="modal-footer flex-center">
                        <!--begin::Button-->
                        <button type="reset" id="kt_modal_load_payments_cancel"
                                class="btn btn-light me-3">Cancel
                        </button>
                        <!--end::Button-->
                        <!--begin::Button-->
                        <button type="submit" id="kt_modal_load_payments_submit"
                                class="btn btn-primary">
                            <span class="indicator-label">Loading Payments</span> <span
                                    class="indicator-progress">Please wait... <span
                                        class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                        </button>
                        <!--end::Button-->
    ...
    <!--end::Modal - Create Payments from tmeplate-->

    <!--begin::Modal - Remove Project Users-->
    <div class="modal fade" id="kt_modal_remove_user" tabindex="-1"
         aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog mw-650px">
            <!--begin::Modal content-->
    ...
    <!--end::Modal - Remove Project Users-->

    <!--begin::Modal - Change Project Client-->
    <div class="modal fade" id="kt_modal_change_client" tabindex="-1"
         aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog mw-650px">
            <!--begin::Modal content-->
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="text-center mb-7">
                        <!--begin::Title-->
                        <h1 class="mb-3">Change Client</h1>
                        <!--end::Title-->
                    </div>
                    <!--end::Heading-->
                    <!--begin::Users-->
                    <div class="mb-15">
                        ...
                        <div class="mh-375px scroll-y me-n7 pe-7">
                            <?php
                            $reg_clients = aireno_get_contacts($user_id);
                            ?>
                            <select id="clientSelect2"
                                    class="form-select form-select-solid">
                                <option></option>
                                <?php
                                foreach ($reg_clients as $reg_client) {
                                    $reg_client_data = aireno_get_userdata($reg_client);
                                    ?>
                                    <option value="<?= $reg_client ?>"
                                        <?= ($client == $reg_client) ? 'selected' : '' ?>
                                            data-kt-rich-content-icon="<?= $reg_client_data->avatar ?>"
                                            data-kt-rich-content-subcontent="<?= $reg_client_data->email ?>">
                                        <?= $reg_client_data->display_name ?></option>
                                    <?php
                                }
                                ?>
                            </select>
                    ...
                    <!--begin::Actions-->
                    <div class="d-flex flex-center mt-15">
                        <button type="reset" id="kt_modal_change_client_cancel"
                                data-bs-dismiss="modal" class="btn btn-active-light me-3">Cancel
                        </button>
                        <button type="submit" id="kt_modal_change_client_submit"
    ...
    <!--end::Modal - Change Project Client-->
    ...
    <!--begin::Modal - Add Activity-->
    <div class="modal fade" id="kt_modal_add_activity" tabindex="-1"
         aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog mw-650px">
            <!--begin::Modal content-->
            <div class="modal-content">
                <form class="form" enctype="multipart/form-data" id="kt_modal_add_activity_form">
                    <!--begin::Modal header-->
                    ...
                    <div class="modal-body scroll-y pt-0 pb-15">
                        ...
                        <div class="w-100 mb-5">
                            <div class="row">
                                <div class="col-md-6 fv-row">
                                    <label class="required fs-5 fw-bold mb-2">Activity Type</label>
                                    <select class="form-select mb-1 cursor-pointer" data-control="select2"
                                            data-placeholder="Choose Type"
                                            name="activity_type">
                                        <option value="add_quote">Added New Quote</option>
                                        <option value="edit_quote">Edited Quote</option>
                                        <option value="delete_quote">Deleted Quote</option>
                                        <option value="add_user">Added User</option>
                                        <option value="delete_user">Deleted User</option>
                                        <option value="change_status">Changed Status</option>
                                        <option value="update_startdate">Updated Start Date</option>
                                        <option value="sent_payment">Sent Payment</option>
                                        <option value="receive_payment">Received Payment</option>
                                        <option value="mark_done">Marked Schedule Item Done</option>
                                        <option value="upload_file">Uploaded New File</option>
                                        <option value="accept_quote">Accepted Quote</option>
                                        <option value="canceled_project">Canceled Project</option>
                                    </select>
                                </div>
                                <div class="col-md-6 fv-row">
                                    <label class="required fs-5 fw-bold mb-2">Activity Date Time</label>
                                    <input class="form-control form-control-solid flatpickr-input" placeholder=""
                                           name="activity_datetime" value="2022-11-18" type="text" readonly="readonly">
                                </div>
                            </div>
                        </div>
                        <!--end:Type & DateTime-->
                        <!--Begin:Activity Title-->
                        <div class="w-100 mb-5 fv-row">
                            <label class="required fs-5 fw-bold mb-2">Activity Content</label>
                            <textarea class="form-control form-control-solid" placeholder="Content"
                                      name="activity_content" rows="3"></textarea>
                        </div>
                        <!--End:Activity Title-->
                        <!--Begin:Activity User-->
                        <div class="w-100 mb-5 fv-row">
                            <label class="required fs-5 fw-bold mb-2">Activity User</label>
                            <select class="form-select" data-kt-element="activity_user"
                                    data-control="select2" data-placeholder="Assign users">
                                <?php
                                foreach ($team_members as $team_member) {
                                    ?>
                                    <option
                        ...
                        <div class="d-flex flex-center">
                            <!--begin::Actions-->
                            <button type="reset" id="kt_modal_add_activity_form_cancel"
                                    data-bs-dismiss="modal" class="btn btn-active-light me-3">Cancel
                            </button>
                            <button type="submit" id="kt_modal_add_activity_form_submit"
