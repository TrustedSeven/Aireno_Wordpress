                                        ...
                                        <div
                                            ...
                                            <div class="d-flex flex-column">
												...
												<span
                                                    ...
                                                    <a href="javascript:void(0)"
                                                       ...
                                                       data-bs-target="#kt_modal_edit_project_name"> <i class="bi bi-pencil-fill fs-4 text-dark"></i>
                                                    </a> 
                                                  <span class="badge badge-light-success me-auto cursor-pointer project-status"
                                                            data-bs-toggle="modal" 
                                                        data-bs-target="#kt_modal_manage_project_status"><div data-bs-toggle="tooltip" data-bs-placement="top" title="Current status of project. Click to change">
                                            ...
                                            <div class="d-flex mb-4">
                                                    ...
                                                    <a href="javascript:void(0)"
                                                       ...
                                                       data-bs-toggle="modal"
                                                       data-bs-target="#kt_modal_upgrade_plan">Get Extra Help <i class="fa-regular fa-handshake-angle fw-bolder"></i>
                                                    </a>
                                                </span>
                                                <?php
                                                        ...
                                                        if ($projectStatus->status != 'completed' &&
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a href="javascript:void(0)"
                                                                   ...
                                                                   data-bs-toggle="modal"
                                                                   data-bs-target="#kt_modal_manage_project_fee">Manage Project Fee</a>
                                                            </div>
                                                            <!--end::Menu item-->
                                                            <!--begin::Menu item-->
                                            ...
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <div class="min-w-125px py-3 px-4 me-6 mb-3">
                                                    ...
                                                    <div class="symbol-group symbol-hover mb-3">
                                                        ...
                                                        foreach ($team_members as $team_member) {
                                                            ?>
                                                      <a class="symbol symbol-35px symbol-circle" href="<?= get_author_posts_url($team_member->id) ?>" target="_blank" data-bs-toggle="tooltip" title="<?= $team_member->display_name ?>">
                                                          <img class="mw-100" src="<?= $team_member->avatar ?>" alt="avatar"/>
                                                         </a> 
                                                            <?php
                                                        }
                                                        ?>
                        ...
                        <div class="tab-content">
                                        ...
                                        <div class="card" id="kt_quotes_summary">
                                            <div class="card-header collapsible cursor-pointer"
                                              ...
                                              <div class="card-title">
                                               <h3 class="fw-bolder">
                                               <i class="fa-light fs-4 me-1 text-danger fa-scanner-keyboard"></i> Quote Breakdown</a>
                                               </h3>
                                              </div>
                                                <div class="card-toolbar">
                                                  ...
                                                  <a class="btn btn-light-dark" href="javascript:void(0)" id="btnPrintQuotes" title="Print to PDF"><i class="fa-regular fa-print"></i></a>
                                                  </div>
                                                </div>
                                            </div>
                                            <div id="kt_quotes_card_collapsible" class="collapse show">
                                                <div class="card-body" id="kt_quotes_summary_body">
                                                 ...
                                                 <div class="scroll-x hover-scroll d-flex">
                                                  ...
                                                  <button class="btn btn-flex btn-light-danger px-6 dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                   <span class="svg-icon svg-icon-2x"><i class="<?php echo $scope_photo; ?> fs-2 text-dark fw-bolder p-0"></i></span>
                                                  ...
                                                  <ul class="dropdown-menu mt-n20">
                                                    <li><a class="dropdown-item" target="_blank" href="<?= get_permalink($scope) ?>">Edit Quote</a></li>
                                                    <li><a class="dropdown-item btn_aireno_delete_quote" data-quote-id="<?= $scope ?>" href="javascript:void(0)">Delete quote</a></li>
                                                  </ul>
                                                </div>
                                                            <?php
                                                        }
                                              ...
                                              <div class="card-footer">
                                                    ...
                                                    <div class="badge bg-danger text-wrap fs-3 fw-bolder float-end">$<?php echo $project_budget; ?></div>
                                              </div>
                                            </div>
                                        </div>
                                        <!--end::Quote Summary-->
                                        ...
                                        <div class="card" id="kt_chat_messenger">
                                            ...
                                            <div class="card-header collapsible cursor-pointer rotate"
                                                ...
                                                <div class="card-title">
                                                    <!--begin::User-->
                                                   <h3 class="fw-bolder">
                                                     <i class="fa-light fs-4 text-danger fa-comments-question-check"></i> Team
                                                      Chat
                                                    </h3>
                                                    <!--end::User-->
                                                </div>
                                                ...
                                                <!--begin::Card toolbar-->
                                                <div class="card-toolbar">
                                                     <a class="btn btn-light-danger btn-sm btnLoadContacts" href="javascript:void(0)">
                                            ...
                                            <div class="card-header collapsible cursor-pointer rotate"
                                                ...
                                                <div class="card-title">
                                                    ...
                                                    <div class="d-flex justify-content-center flex-column me-3">
                                                        ...
                                                        ?>
                                                      <h3 class="fw-bolder"><i class="fa-regular fs-4 text-danger fa-list-check"></i> Tasks  <span class="badge badge-square badge-light-danger tasks_count"><?= intval($tasks->post_count) ?></span></h3>
                                                    </div>
                                                    <!--end::User-->
                                                </div>
                                                <!--end::Title-->
                                                        ...
                                                        <div class="d-flex align-items-center mb-6 d-none overlay"
                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <div class="d-flex flex-column">
                                                                    ...
                                                                    <!--end::Description-->
                                                                    <!--begin::Link-->
                                                                    <div class="text-gray-400 fw-bold fs-7" data-bs-toggle="tooltip" data-bs-placement="top" title="Users assigned"
                                                                         data-kt-element="users"><i class="fa-solid fa-user-plus"></i>: </div>
                                                                ...
                                                                <div class="d-flex align-items-center mb-6 overlay"
                                                                    ...
                                                                    <div class="flex-grow-1">
                                                                        ...
                                                                        <div class="d-flex flex-column">
                                                                            ...
                                                                            <!--begin::Link-->
                                                                            <div class="text-gray-400 fw-bold fs-7" data-bs-toggle="tooltip" data-bs-placement="top" title="Users assigned"
                                                                                 data-kt-element="users"><i class="fa-solid fa-user-plus"></i>: 
                                            ...
                                            <div class="card-header collapsible cursor-pointer rotate"
                                                ...
                                                <div class="card-title">
                                                    ...
                                                    <div class="d-flex justify-content-center flex-column me-3">
                                                        ...
                                                        ?>
                                                 <h3 class="fw-bolder mb-1"><i class="fa-regular fs-4 text-danger fa-note"></i> Notes <span class="badge badge-square badge-light-danger notes_count"><?= intval($notes->post_count) ?></span></h3>
                                                    </div>
                                                    <!--end::User-->
                                                </div>
                                                <!--end::Title-->
                            ...
                            <div class="tab-pane fade show <?= $tab == 'project-schedules' ? 'active' : '' ?>"
                                ...
                                <div class="row g-9 mb-9">
                                    <div class="col-md-4">
                                        <a href="javascript:void(0)" class="btn btn-primary w-100 fs-6 fw-bolder px-8 py-4"
                                           id="btnCreateSchedule"><i class="fa-solid fa-calendar-plus text-light"></i> Add target</a>
                                    </div>
                                    <div class="col-md-4">
                                        <a href="javascript:void(0)" class="btn btn-success fw-bolder w-100 fs-6 px-8 py-4"
                                           id="btnCreateScheduleByTemplate" data-bs-toggle="modal"
                                           data-bs-target="#kt_modal_load_schedules"><i class="fa-regular fa-folders text-light"></i> Load a template</a>
                                    </div>
                                </div>
                                <!--end::Row-->
                                <?php
                            ...
                            <div class="tab-pane fade show <?= $tab == 'project-payments' ? 'active' : '' ?>"
                                ...
                                <div class="row g-9 mb-9">
                                    <div class="col-md-4">
                                        <a href="javascript:void(0)" class="btn btn-primary fw-bolder w-100 fs-6 px-8 py-4"
                                           id="btnCreatePayment"><i class="fa-light fa-file-invoice text-light"></i> New Payment</a>
                                    </div>
                                    <div class="col-md-4">
                                        <a href="javascript:void(0)" class="btn btn-success fw-bolder w-100 fs-6 px-8 py-4"
                                           data-bs-toggle="modal"
                                           data-bs-target="#kt_modal_load_payments"><i class="fa-regular fa-folders text-light"></i> Load a templates</a>
                                    </div>
                                </div>
                                <!--end::Row-->
                                <?php
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            if (!aireno_user_left_review_on_project($project_id, $user_id)) {
                                                ?>
                                                <form id="ratingForm" enctype="multipart/form-data" method="post" class="mb-10">
